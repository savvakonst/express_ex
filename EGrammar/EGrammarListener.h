...
public:
  ...
  virtual void enterCallLinkedTypeCast(EGrammarParser::CallLinkedTypeCastContext *ctx) = 0;
  virtual void exitCallLinkedTypeCast(EGrammarParser::CallLinkedTypeCastContext *ctx) = 0;
