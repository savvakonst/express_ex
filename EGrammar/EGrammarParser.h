...
public:
  ...
  class  NeighborhoodPointContext : public ExprContext {
  public:
    NeighborhoodPointContext(ExprContext *ctx);
  ...
  class  CallLinkedTypeCastContext : public ExprContext {
  public:
    CallLinkedTypeCastContext(ExprContext *ctx);
  ...
  public:
    ...
    std::vector<ExprContext *> expr();
    ExprContext* expr(size_t i);
    antlr4::tree::TerminalNode *MOREEQ();
