...
calc_block_0x183d80_level_1_0:                    ; preds = %load_block_0x183d80_level_1_0
  %vb13 = call double @convolveFunction(double* %offset_val_incr_, double* inttoptr (i64 1531151873040 to double*), i64 3, i64 -1)
...
calc_block_0x183d80_level_1:                      ; preds = %load_block_0x183d80_level_1
  %vb1314 = call double @convolveFunction(double* %offset_val_incr_12, double* inttoptr (i64 1531151873040 to double*), i64 3, i64 -1)
...
calc_block_0x183d80_level_130:                    ; preds = %load_block_0x183d80_level_129
  %vb1335 = call double @convolveFunction(double* %offset_val_incr_33, double* inttoptr (i64 1531151873040 to double*), i64 3, i64 -1)
