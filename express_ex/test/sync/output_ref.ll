...
calc_block_0x183d80_level_1_0:                    ; preds = %load_block_0x183d80_level_1_0
  %vb13 = call double @convolveFunction(double* %offset_val_incr_, double* inttoptr (i64 2083957026080 to double*), i64 3, i64 -1)
...
calc_block_0x183d80_level_1:                      ; preds = %load_block_0x183d80_level_1
  %vb1316 = call double @convolveFunction(double* %offset_val_incr_14, double* inttoptr (i64 2083957026080 to double*), i64 3, i64 -1)
...
calc_block_0x183d80_level_132:                    ; preds = %load_block_0x183d80_level_131
  %vb1337 = call double @convolveFunction(double* %offset_val_incr_35, double* inttoptr (i64 2083957026080 to double*), i64 3, i64 -1)
